...
public class UtilsAsyncTask extends AsyncTask<String, Void, Movie[]> {

    // LOG message and Private Constructor
    private static final String LOG_TAG = UtilsAsyncTask.class.getSimpleName();
    //STATICS for the API call
    private String TMDB_BASE_URL = "https://api.themoviedb.org/3/movie";
    private String API_KEY_BASE = "api_key";
    private String API_KEY = "HERE_YOU_SHOULD_PUT_YOUROWN_PRIVATE_kEY";
    ...
    public UtilsAsyncTask(OnTaskCompleted listener) {
        super();
        mListener = listener;
    }
